    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.IntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(100)], verbose_name='В процентах')),
            ],
            options={
                'verbose_name': 'Скидка',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notice', models.CharField(blank=True, max_length=150, null=True, verbose_name='Примечания к заказу')),
